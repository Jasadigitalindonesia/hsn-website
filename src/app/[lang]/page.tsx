        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <AnimatedSection className="w-full lg:w-1/2">
              ...
              <Link href={`/${lang}/profil`} className="inline-flex items-center gap-2 bg-primary hover:bg-[#b0924b] text-white font-semibold py-3 px-6 rounded transition-colors">
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            {categories.map((cat, i) => (
              <AnimatedSection key={i} delay={i * 0.1}>
                <Link href={`/${lang}/kategori`} className="group block relative rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 bg-white">
          ...
          <AnimatedSection className="text-center mt-12" delay={0.2}>
            <Link href={`/${lang}/kategori`} className="inline-flex items-center gap-2 border-2 border-primary text-primary hover:bg-primary-hover hover:text-white font-semibold py-3 px-8 rounded transition-colors">
              ...
              <AnimatedSection key={product.id || i} delay={0.2 + (i * 0.1)}>
                <div className="bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100 group">
                  ...
                  <div className="p-6">
                    ...
                    <Link href={`/${lang}/produk/detail`} className="inline-flex items-center text-primary font-bold hover:text-accent transition-colors">
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <AnimatedSection className="flex justify-between items-end mb-12">
            ...
            <Link href={`/${lang}/artikel`} className="hidden md:flex items-center gap-2 text-primary font-semibold hover:underline">
              ...
              <AnimatedSection key={i} delay={i * 0.2}>
                <div className="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow h-full">
                  ...
                  <div className="p-6">
                    ...
                    <Link href={`/${lang}/artikel`} className="text-primary text-sm font-semibold hover:underline">Baca Selengkapnya</Link>
                  </div>
                </div>
              </AnimatedSection>
            ))}
          ...
          <AnimatedSection className="mt-8 text-center md:hidden" delay={0.4}>
            <Link href={`/${lang}/artikel`} className="inline-flex items-center gap-2 text-primary font-semibold hover:underline">
              Lihat Semua <ArrowRight className="w-4 h-4" />
            </Link>
          </AnimatedSection>
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          <AnimatedSection>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <Link href={`/${lang}/kontak`} className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-primary font-bold py-4 px-8 rounded-full transition-colors flex items-center justify-center gap-2">
