...
export default async function Page({ params, searchParams }: { params: any, searchParams: Promise<{ [key: string]: string | string[] | undefined }> }) {
  ...
  const t = lang === 'en' ? {
    ...
    techDesc: "PT Harvest Selaras Nusantara Medica presents a variety of selected products from trusted brands that meet international quality standards.",
    ...
    techDesc: "PT Harvest Selaras Nusantara Medica menghadirkan berbagai produk pilihan dari brand terpercaya yang telah memenuhi standar kualitas internasional.",
